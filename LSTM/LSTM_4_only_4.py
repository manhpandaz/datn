...
plt.plot(df_selected.index[-len(y_test):],
         y_test[:, 0], label='Actual', color='blue')
plt.plot(df_selected.index[-len(y_test):],
         y_pred_lstm[:, 0], label='LSTM Prediction')
...
plt.figure(figsize=(12, 6))
plt.plot(df_selected.index[-len(y_test):],
         y_test[:, 1], label='Actual', color='blue')
plt.plot(df_selected.index[-len(y_test):],
         y_pred_lstm[:, 1], label='LSTM Prediction')
plt.title('USD_W - LSTM')
plt.xlabel('Time Steps')
plt.ylabel('Value')
plt.legend()
...
plt.figure(figsize=(12, 6))
plt.plot(df_selected.index[-len(y_test):],
         y_test[:, 2], label='Actual', color='blue')
plt.plot(df_selected.index[-len(y_test):],
         y_pred_lstm[:, 2], label='LSTM Prediction')
plt.title('USD_W - LSTM')
plt.xlabel('Time Steps')
plt.ylabel('Value')
plt.legend()
